...
// keys are built from local components and day arithmetic runs over those
...
/** Monday-first weekday position, 0 to 6. */
...
/** Every day of the anchor's month, padded to whole Monday-first weeks. */
